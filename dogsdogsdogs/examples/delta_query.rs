    ...
    timely::execute_from_args(std::env::args().skip(2), move |worker| {
        ...
        let mut input = worker.dataflow::<usize,_,_>(|scope| {
            ...
            let (triangles_prev, triangles_next) = scope.scoped::<AltNeu<usize>,_,_>("DeltaQuery (Triangles)", |inner| {
                ...
                let changes1 = propose(&changes, forward_key_neu.clone(), key2.clone(), Default::default());
                ...
                let changes2 = propose(&changes, reverse_key_alt.clone(), key1.clone(), Default::default());
                ...
                let changes3 = propose(&changes, forward_key_alt.clone(), key1.clone(), Default::default());
